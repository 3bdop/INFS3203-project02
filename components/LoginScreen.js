  ...
  const handleLogin = () => {
    ...
    signInWithEmailAndPassword(auth, email, password)
      ...
      .catch((error) => {
        ...
        setSignedIn(false); setIncorrectLog(true); setIsLoading(false);
  ...
  return (
    ...
    >
      <SafeAreaView style={styles.container}>
        ...
        <View style={{ justifyContent: "center", alignItems: "center", paddingTop: screenHeight * 0.08 }}>
          <Input
            autoCapitalize='none'
            value={email}
        ...
        {incorrect ? <Text style={{ marginLeft: 30, color: "red", fontWeight: "bold" }}>Incorrect Email or Password</Text> : null}
        <TouchableOpacity style={{ alignItems: "flex-end", paddingRight: screenWidth * .08 }}>
          <Text style={{ fontWeight: 'bold' }}>Forgot Password?</Text>
        </TouchableOpacity>
        <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "center" }}>
          <Button
            onPress={handleLogin}
            title={isLoading ? <ActivityIndicator size="small" color="#fff" /> : "Log In"}
        ...
        <View style={{ flex: 1 }}>
          ...
          <View style={{ flex: 1, flexDirection: "row", justifyContent: "space-around", paddingTop: screenHeight * 0.02 }}>
